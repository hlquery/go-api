...
// AddDocument adds a typed document to a collection.
func (d *Documents) AddDocument(collection string, document Document) (*Response, error) {
	return d.Add(collection, map[string]interface{}(document))
}
